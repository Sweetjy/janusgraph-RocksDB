...
public interface OrderedKeyValueStore extends KeyValueStore {
     ...
     * That means, (1) the key lies between the query's start and end buffers, (2) satisfied the filter condition (if any)
     * (3) and the position of the result in the result list iterator is less than the given limit.
     *
